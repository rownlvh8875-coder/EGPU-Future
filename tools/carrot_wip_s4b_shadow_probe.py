...
Never add it to manager/process_config in Stage 4B.
"""
...
def main() -> int:
  ...
  # tinygrad reads PROFILE during import/device setup. Set it before importing
  # openpilot modeld/tinygrad modules.
  if args.profile:
    ...
    try:
      ...
      while time.monotonic() < start_deadline:
        ...
        if model is None:
          ...
          # Do not infer on the load frame; separate load overhead from steady-state samples.
          continue
